...
function get_custom_logo( $blog_id = 0 ) {
	...
	if ( $custom_logo_id ) {
		$html = sprintf( '<a href="%1$s" class="custom-logo-link" rel="home" itemprop="url">%2$s<img class="isholicious" src="http://localhost:8080/wpbeginner/wp-content/uploads/2017/04/newlogo.png"/></a>',
			esc_url( home_url( '/' ) ),
